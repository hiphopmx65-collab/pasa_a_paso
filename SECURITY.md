...
En FASE 1 el gateway ya restringe CORS al mismo allowlist configurado para HTTP y sólo acepta el token local `REALTIME_DEV_AUTH_TOKEN` mientras se completa la validación JWT real.
